package com.deals.loanOffer;

import com.deals.customEnum.EmploymentStatus;
import com.deals.customEnum.Gender;
import com.deals.customEnum.MaritalStatus;
import com.deals.dto.*;
import com.deals.exception.QualifyLoanException;
...
public class LoanOfferService {
    ...
    LoanOfferService loanService = new LoanOfferService();
    ...
    private static final Logger LOGGER = Logger.getLogger(LoanOfferService.class);

    private String emailPattern = "^(.+)@(.+)$";
    private String nameCharacters = "^[A-Z][a-z]{2,}(?: [A-Z][a-z]*)*$";

    public List<LoanOfferDTO> generateTypesOfLoanOffer(LoanApplicationRequestDTO requestDTO) {
    ...
    public List<LoanOfferDTO> offers(LoanApplicationRequestDTO requestDTO )
    {
        ...
        return generateTypesOfLoanOffer(requestDTO);
    }
